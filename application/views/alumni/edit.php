				...
				<div class="card-body">
		          ...
		          <div class="card shadow mb-4">
		            <div class="card-header py-3">
						<h4 class="m-0 font-weight-bold text-danger">Edit Alumni
		            ...
		            <div class="card-body">
		            	<div class="row">
				            ...
				            <div class="form-group">
		                		...
		                		<input type="text" class="form-control" name="username" id="username" value="<?=$alumni->username; ?>">
		                		<?= form_error('username'); ?>
		                	</div>
...
<!--                             <div class="form-group">
				                		<label for="pekerjaan" class="hitam-tebal">Pekerjaan</label>
				                		<input type="text" class="form-control" name="pekerjaan" id="pekerjaan" value="<?=$alumni->pekerjaan; ?>">
