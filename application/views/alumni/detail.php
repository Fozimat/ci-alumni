				...
				<div class="card-body">
		          ...
		          <div class="card shadow mb-4">
		            <div class="card-header py-3 bg-primary">
		              <h4 class="m-0 font-weight-bold text-light">Terdaftar pada : <?= date('d-m-Y, H:i', $alumni->tgl_daftar); ?>
                    ...
                    <div class="row">
                    	<div class="col-lg-2 text-center">
                    		...
                    		<a class="btn btn-success ml-5 mt-3" href="<?= site_url("alumni/edit/".$alumni->id) ;?>"><i class="fa fa-edit"></i> Edit</a>
                    	</div>
                    	<div class="col-lg-10">
								...
								<li class="list-group-item">
									<div class="row">
	                    				<div class="col-lg-12">
	                    					...
	                    					<a class="btn btn-info float-right mr-3" href="<?= base_url('alumni/cetakAlumniSatu/'.$alumni->id); ?>" target="_blank"><i class="fa fa-print"></i> Cetak</a>
	                    				</div>
	                    			</div>
								</li>
