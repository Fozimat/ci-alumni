...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="<?php echo ($this->uri->segment(1) == "home" ? 'nav-item active' :  'nav-item'); ?>">
      ...
      <li class="<?php echo ($this->uri->segment(1) == "alumni" ? 'nav-item active' :  'nav-item'); ?>">
        <a class="nav-link" href="<?= site_url('alumni'); ?>">
          <i class="fas fa-fw fa fa-graduation-cap"></i>
          <span>Alumni</span></a>
      </li>

      <!-- <li class="<?php echo ($this->uri->segment(1) == "user" ? 'nav-item active' :  'nav-item'); ?>">
      ...
      <li class="<?php echo ($this->uri->segment(1) == "laporan" ? 'nav-item active' :  'nav-item'); ?>">
      ...
      <li class="<?php echo ($this->uri->segment(1) == "pengaturan"  && $this->uri->segment(2) == "" ? 'nav-item active' :  'nav-item'); ?>">
        <a class="nav-link" href="<?= base_url('pengaturan'); ?>">
          <i class="fas fa-fw fa fa-cog"></i>
          <span>Edit Profil</span></a>
      </li>

      <!-- <li class="<?php echo ($this->uri->segment(1) == "pengaturan" && $this->uri->segment(2) == "password" ? 'nav-item active' :  'nav-item'); ?>">
        <a class="nav-link" href="<?= base_url('pengaturan/password'); ?>">
          <i class="fas fa-fw fa fa-unlock-alt"></i>
          <span>Edit Password</span></a>
      </li> -->

      <li class="<?php echo ($this->uri->segment(1) == "pesan" ? 'nav-item active' :  'nav-item'); ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?= base_url(''); ?>upload/admin/<?= $this->session->userdata('foto'); ?>">
              </a>
